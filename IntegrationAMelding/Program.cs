...
namespace IntegrationAMelding
{
    public class Program
    {
        static void Main()
        {
            ...
            //EINAR NORHEIM
            //910253492
            var pins = new [] { "ajhhs", "piksd", "iuyhs", "asdfg", "rtefs", "loj7s", "mmmyp", "juksa", "fizck", "qicks", "98ujs", "mnbvs", "qwers", "polze", "ztang", "alt1n", "zcatt", "kjasd", "23as3", "lkiju", "4564s", "zxhfg", "alsks", "ooiks", "likme", "kaffe", "arbei", "00kks", "mjhgg", "ziste"};
        ...
        private static int SubmitFormTask()
        {
            using (var client = new IntermediaryInboundExternalBasicClient())
            {
                ...
                var receipt = client.SubmitFormTaskBasic(ConfigurationManager.AppSettings["systemUserName"], ConfigurationManager.AppSettings["systemPassword"], null, null, null, null, fts);
        ...
        private static string GetArchiveReference(int receiptId)
        {
            using (var client = new ReceiptExternalBasicClient())
            {
                ...
                var receipt = client.GetReceiptBasic(ConfigurationManager.AppSettings["systemUserName"], ConfigurationManager.AppSettings["systemPassword"], receiptSearch);
